...
team_colors_bottom5 <- c(
  "Cincinnati Bengals" = "sienna1",    # Bengals Orange
  "Las Vegas Raiders" = "grey89",      # Raiders Gray
  "Cleveland Browns" = "pink",      # Browns Orange/Red
  "Tennessee Titans" = "skyblue",      # Titans Navy Blue
  "New York Jets" = "limegreen"          # Jets Green
)
...
bottom_5_teams_srs %>%
  ...
  theme(
    ...
    axis.title.y = element_text(face = "bold", size = 20),
    axis.title.x = element_text(face = "bold", size = 18),
    axis.text.x = element_text(face = "bold", size = 15, color = "black", hjust = 0.5),
